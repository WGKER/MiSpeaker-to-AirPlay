...
2026-06-18\
版本：miair_v0.8.5-alpha-arm64\
更新：\
    同步源项目更新，继续精简一键更新，替换web谷歌字体为本地，避免报错\

    v0.8.5-alpha Latest
        重构 AirPlay 引擎，大幅优化 AirPlay 稳定性。
        优化 AirPlay 音量映射。
        移除部分无用代码。

    v0.7.4-alpha\
        改进自动应对故障处理逻辑。\
        新增“兼容模式”功能，修复部分老旧设备无法暂停与拖动进度的问题。\

2026-05-14

版本：miair_v0.5.4-alpha-arm64

更新：累积

     ***更新到自用miair_v0.5.4-alpha-arm64
     ...
     v0.5.3-alpha
     新增一键更新功能
     新增 TME CONNECT 、QPlay 支持
     修复部分旧款设备无法暂停的问题
     修复部分设备播放时显示雷霆封面的问题
     修复部分场景下，自动故障应对不工作的问题
     修复部分场景下，设备列表无法正常加载的问题
